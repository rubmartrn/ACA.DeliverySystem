...
namespace ACA.DeliverySystem.Business.Tests
{
    public class ItemServiceTest
    {
        ...
        public async Task CreateItem_Success()
        {
            ...
            var item = new Item { Id = 1, Name = "fast food",Description = "5 pies", Price = 25 };
        ...
        public async Task Delete_Success()
        {
            ...
            var items = new List<Item>
            {
                new Item { Id = 1,  Name = "fast food",Description = "5 pies", Price = 25},
                new Item { Id = 2,  Name = "Donar", Description = "6 pies", Price = 35},
            };
        ...
        public async Task GetAllItems_Success()
        {
            ...
            {
                new ItemViewModel { Id = 1,  Name = "fastfood", Description = "5 pies", Price = 25 },
                new ItemViewModel { Id = 2,  Name = "Donar",Description = "6 pies", Price = 35 },
            };
        ...
        public async Task GetItemById_Success()
        {
            ...
            //Assert
            _iItemRepositoryMock.Verify(m => m.GetById(It.Is<int>(c => c == 1), 
        ...
        public async Task Update_Success()
        {
            ...
            var currentItem = new Item { Id = 3,  Name = "fastfoodik", Description = "12 pies", Price = 45 };
