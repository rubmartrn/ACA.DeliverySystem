...
namespace ACA.DeliverySystem.Business.Tests
{
    public class UserServiceTest
    {
        ...
        private Mock<ITokenService> _tokenMock = new Mock<ITokenService>();
        private IUserService service => new UserService(_uowMock.Object, _mapperMock.Object, _tokenMock.Object);
        private Mock<List<Order>> _mockOrders = new Mock<List<Order>>();
        private Mock<List<OrderItem>> _mockItems = new Mock<List<OrderItem>>();
        private Mock<List<OrderItemViewModel>> _mockItemViewModels = new Mock<List<OrderItemViewModel>>();
        ...
        public async Task CreateUser_Success()
        {
            ...
            var user = new User
            {
                ...
                Name = "Artur",
                SurName = "Nikoxosyan",
                Orders = _mockOrders.Object,
                Email = "art56@gmail.com",
